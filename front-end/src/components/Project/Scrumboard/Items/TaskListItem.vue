...
<<<<<<< HEAD
  ...
  <!-- <div class="card tasklist-item" v-if="!isEditing" @click.prevent="startEditing"> -->
    <div class="edit" v-if="!isNewItem"><a href="https://www.google.com/search?q=david+damiano&ei=nWWrYMiWG5fbkgW1sKuoDg&gs_ssp=eJzj4tVP1zc0TDOuKjI0y6o0YPTiTUksy0xRSEnMzUzMywcAilcJlw&oq=davi&gs_lcp=&sclient=gws-wiz"><i class="fas fa-pen"></i></a></div>
=======
  
  <div class="card tasklist-item" v-if="!isEditing" @click.prevent="startEditing">
>>>>>>> 9b5099075a0d5ba80fd4b716596e8e735b0c6822
    <div class="card-body">
